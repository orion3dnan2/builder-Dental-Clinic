...
export default function Accounting() {
  ...
  const content = {
    ...
    en: {
      ...
      subtitle:
        "Comprehensive accounting system for professional financial management",
      overview: "Overview",
  ...
  const quickActions: QuickAction[] = [
    ...
    },
    {
      ...
      description: isArabic
        ? "تسجيل مصروف أو شراء جديد"
        : "Record new expense or purchase",
      icon: Wallet,
      color: "bg-red-500",
    ...
    },
    {
      ...
      description: isArabic
        ? "إرسال تذكير للمدفوعات المتأخرة"
  ...
  const getHealthScore = () => {
    const score =
      (financialData.profitMargin + financialData.monthlyGrowth * 2) / 3;
  ...
  return (
    <DashboardLayout>
      <div
        className={`space-y-8 ${isArabic ? "rtl" : "ltr"}`}
        lang={isArabic ? "ar" : "en"}
      >
        {/* Enhanced Header */}
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-4 mt-4">
              <div className="flex items-center gap-2">
                <div
                  className={`w-3 h-3 rounded-full ${getHealthScore() > 70 ? "bg-green-500" : getHealthScore() > 40 ? "bg-yellow-500" : "bg-red-500"}`}
                ></div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          <Card className="border-l-4 border-l-green-500 hover:shadow-lg transition-all duration-200">
            ...
            <CardContent>
              ...
              <div className="mt-3 text-xs text-muted-foreground">
                {isArabic ? "متوسط يومي:" : "Daily avg:"}{" "}
                {formatCurrency(financialData.avgDailyRevenue)}
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-l-red-500 hover:shadow-lg transition-all duration-200">
            ...
            <CardContent>
              ...
              <div className="mt-3 text-xs text-muted-foreground">
                {isArabic ? "نسبة من الإيرادات:" : "Revenue ratio:"}{" "}
                {(
                  (financialData.totalExpenses / financialData.totalRevenue) *
                  100
                ).toFixed(1)}
                %
              </div>
            ...
            <CardContent>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-orange-600 font-medium">
                  ...
                  {isArabic ? "فاتورة معلقة" : "invoices pending"}
                </span>
              </div>
              <div className="mt-3 text-xs text-muted-foreground">
                {isArabic ? "متوسط عمر الدين:" : "Avg age:"}{" "}
                {isArabic ? "12 يوم" : "12 days"}
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="bg-gradient-to-r from-blue-50 to-purple-50 border-none">
          <CardHeader>
            ...
            <CardDescription>
              {isArabic
                ? "إجراءات محاسبية سريعة ومهمة للعمل اليومي"
                : "Quick accounting actions for daily work"}
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <Card className="lg:col-span-2">
                <CardHeader className="flex flex-row items-center justify-between">
                  <div>
                    ...
                    <CardDescription>
                      {isArabic
                        ? "آخر المعاملات المالية المسجلة في النظام"
                        : "Latest financial transactions in the system"}
                    </CardDescription>
                  </div>
                  <Button
                    variant="outline"
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <Badge
                                className={`text-xs border ${getStatusColor(transaction.status)}`}
                              >
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-muted-foreground">
                        {isArabic ? "هدف الشهر" : "Monthly Target"}
                      </span>
                  ...
                  <div className="space-y-3">
                    <h4 className="font-semibold text-sm">
                      {isArabic ? "أهم المؤشرات" : "Key Indicators"}
                    </h4>
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-xs text-muted-foreground">
                          {isArabic ? "سرعة التحصيل" : "Collection Speed"}
                        </span>
                        <Badge
                          variant="outline"
                          className="text-purple-600 border-purple-600"
                        >
                          {isArabic ? "8 أيام" : "8 days"}
                        </Badge>
                      </div>
                    </div>
                  </div>
          ...
          <TabsContent value="transactions" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {isArabic
                    ? "جميع المعاملات المالية مع إمكانية البحث والتصفية المتقدمة"
                    : "All financial transactions with advanced search and filtering"}
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                    ...
                    <table className="w-full">
                      ...
                      <tbody>
                        {filteredTransactions.map((transaction, index) => (
                          <tr
                            key={transaction.id}
                            className={`border-t hover:bg-accent/30 transition-colors ${index % 2 === 0 ? "bg-background" : "bg-muted/20"}`}
                          >
                            <td className="p-4">
                            ...
                            <td className="p-4">
                              <Badge
                                className={`border ${getTypeColor(transaction.type)}`}
                              >
                            ...
                            <td className="p-4">
                              <Badge
                                className={`border ${getStatusColor(transaction.status)}`}
                              >
                                {getStatusLabel(transaction.status)}
                              </Badge>
                            </td>
                ...
                <div className="flex items-center justify-between">
                  <div className="text-sm text-muted-foreground">
                    {isArabic
                      ? `عرض ${filteredTransactions.length} من أصل ${recentTransactions.length} معاملة`
          ...
          <TabsContent value="invoices" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {isArabic
                    ? "إدارة متقدمة للفواتير والمدفوعات"
              ...
              <CardContent>
                <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground mb-6">
                    {isArabic
                      ? "سيتم تطوير هذا القسم قريباً لإدارة الفواتير بشكل متقدم"
                      : "This section will be developed soon for advanced invoice management"}
                  </p>
        ...
        >
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                {isArabic
                  ? "إضافة معاملة مالية جديدة للنظام"
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  placeholder={
                    isArabic ? "وصف المعاملة" : "Transaction description"
                  }
                />
              </div>
              <div className="grid grid-cols-2 gap-4">
                  ...
                  <Select>
                    ...
                    <SelectContent>
                      <SelectItem value="treatment">
                        {isArabic ? "علاج" : "Treatment"}
                      </SelectItem>
                      <SelectItem value="supplies">
                        {isArabic ? "مواد طبية" : "Medical Supplies"}
                      </SelectItem>
                      <SelectItem value="equipment">
                        {isArabic ? "معدات" : "Equipment"}
                      </SelectItem>
                      <SelectItem value="salary">
                        {isArabic ? "رواتب" : "Salary"}
                      </SelectItem>
                    </SelectContent>
                  </Select>
                </div>
