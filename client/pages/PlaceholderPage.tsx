...
export default function PlaceholderPage({
  ...
  const content = {
    ar: {
      ...
      helpText:
        "يمكنك طلب تطوير هذه الصفحة بإرسال تفاصيل أكثر حول ما تريده بالضبط.",
    },
    en: {
      ...
      helpText:
        "You can request development of this page by providing more details about what exactly you need.",
    },
  };
  ...
  return (
    <DashboardLayout>
      <div
        className={`max-w-4xl mx-auto space-y-6 ${isArabic ? "rtl" : "ltr"}`}
        lang={isArabic ? "ar" : "en"}
      >
        {/* Header */}
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card className="border-dashed border-2">
            ...
            <CardContent className="text-center">
              ...
              <p className="text-sm text-muted-foreground mb-6">{t.helpText}</p>
          ...
          {features.length > 0 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {isArabic
                    ? "المميزات التي سيتم إضافتها لهذه الصفحة"
