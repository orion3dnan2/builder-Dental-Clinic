...
export default function Login() {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-primary/5 via-accent/5 to-secondary/10 flex items-center justify-center p-4 ${isArabic ? 'rtl' : 'ltr'}`} lang={isArabic ? 'ar' : 'en'}>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2 flex-wrap">
                        {[
                          ...
                          <Badge
                            key={type.value}
                            variant={loginForm.userType === type.value ? 'default' : 'outline'}
